...
msg = PSmessageSubst_win0(msg, PSwarning_win0.arguments, 1);if (isFModeLayout()) 
 psConfirmFluid("Warning", msg, "", "", "", "");else
 psAlert(msg, "Warning");}
...
msg = PSmessageSubst_win0(msg, PSerror_win0.arguments, 2);if (isFModeLayout()) 
 psConfirmFluid("Error", msg, "", "", "", "");else
 psAlert(msg, "Error");oErr_win0=obj;}
...
var deleteAction = 'oParentWin.aAction_win0(oParentWin.document.win0' + ',"' + name + '")';if (typeof CKEDITOR != 'undefined') UpdateEditorLinkedField();psConfirm2("Delete Confirmation", "Delete current/selected rows from this page?  The delete will occur when the transaction is saved.", "OKCancel", " ", deleteAction);}
...
gFocusObj = document.getElementById(name);if (arguments.length == 0) 
 ...
 psConfirmFluid("Delete Confirmation", "Delete current/selected rows from this page?", "OKCancel", " ", deleteAction, "The delete will occur when the transaction is saved."); else 
 {
 if (typeof CKEDITOR != 'undefined') UpdateEditorLinkedField(); psConfirm2("Delete Confirmation", "Delete current/selected rows from this page?  The delete will occur when the transaction is saved.", "OKCancel", " ", deleteAction); }
 }
}
 ...
 closeCal2(obj);if(!bTabonly || getLastKey_win0() == "\t".charCodeAt(0))
{
 ...
 oChange_win0.form.ICFocus.value=obj.id; else
 document.getElementById(oChange_win0.id).form.ICFocus.value = obj.id; submitAction_win0(oChange_win0.form,oChange_win0.id); oChange_win0 = null; }
...
{
 PSdeferError_win0(obj, "The system does not understand the date you entered. Example date: %1");  return true;}
