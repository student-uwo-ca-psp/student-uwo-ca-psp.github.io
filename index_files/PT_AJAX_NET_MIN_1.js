...
reduceScrollareaHeight:function(id, data, newH)
 {
 ...
 {
 try{
 this.reduceScrollareaHeight(id, sCleanData.substr(0, 200), obj.clientHeight); }
 catch (e) {}
 }
 }
...
closeModal: function(ID){
 ...
 if ((isWinModeless(window) || window.modWin.parent) && this.bModal != 5)
 closeModal(window.modWin.modalID); else
 closeModalAll(); }
 }
 catch (e) { }
