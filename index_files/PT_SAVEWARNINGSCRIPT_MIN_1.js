...
function psConfirmClassic(msgTitle, msg, msgType, event1, event2, pWin) {
 ...
 shtml += "<div id='alertbutton'><a class='PSPUSHBUTTON Left' style='border:0;'><span><input type='button' id='#ALERTYES' name='#ALERTOK' class='PSPUSHBUTTONTBOK' value='"; shtml += (sYes + "' tabindex='0' alt='" + sYes + "' title='" + sYes + "' onclick='" + event1 + ";closeMsg(this);' /></span></a>"); shtml += ("<a class='PSPUSHBUTTON Left' style='border:0;'><span><input type='button' id='#ALERTNO' name='#ALERTNO' class='PSPUSHBUTTONTBOK' value='"); shtml += (sNo + "' tabindex='0' alt='" + sNo + "' title='" + sNo + "' onclick='" + event2 + ";closeMsg(this);' /></span></a>"); }
