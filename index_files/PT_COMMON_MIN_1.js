...
PT_Search.prototype = {
 ...
 if (sPortalUrl.charAt(sPortalUrl.length - 1) !== '/')
  sPortalUrl = sPortalUrl + "/";  ajaxURL = sPortalUrl + "s/WEBLIB_PTIFRAME.ISCRIPT1.FieldFormula.IScript_PT_GetSrchGrpsList?"; var listLoader = new net2.ContentLoader(ajaxURL, null, null, "GET",
 function() {
 ...
 sSGUrl = sPortalGSUrl; if (sCurrCompSrchCat != sSGName) {
 if (sSGName != "PTUS_ALL") {
...
function closeMsg(obj,id) {
 var nRtn = getPTDialog().closeModalMsg(obj,id); setLocalModal(false); if (isFModeLayout() && isAccessibleLayout()) unhidePtWrapper(); if (!isFModeLayout()) getPTDialog().processing(0,3000);  return nRtn;}
...
function AddToHistory(label, keyData, userData, pageName, stateNum, elemNum, classicURL, dashboard, appBcData, nPost, userQueryString, bReturnToLastPage) {
 ...
 url = mergeUserQsParams(url,["page", "ptrmtback"]); var pt_history = getHistoryObject(),
